...
function lazyRogueLoad.LoadParseRogue()
	...
	lazyRogue.actions.flourish         = lazyRogue.Action:New("flourish",         "Ability_DualWield", nil, nil, true)
	...
	lazyRogue.actions.sprint           = lazyRogue.Action:New("sprint",           "Ability_Rogue_Sprint", nil, nil, true)
	...
	lazyRogue.actions.tx               = lazyRogue.Action:New("tx",               "Ability_Rogue_SurpriseAttack")
	lazyRogue.actions.vanish           = lazyRogue.Action:New("vanish",           "Ability_Vanish")
	lazyRogue.actions.ywd              = lazyRogue.Action:New("ywd",              "Spell_Holiday_ToW_SpiceCloud")
	lazyRogue.actions.xszc             = lazyRogue.Action:New("xszc",             "inv_misc_dust_infinite")
	...
	function lazyRogue.masks.isSwinged()
		if not st_timer then
			lazyRogue.p("need SP_SwingTimer.")
			return false
		end
	...
	function lazyScript.bitParsers.ifSwinged(bit, actions, masks)
		...
		table.insert(masks, lazyScript.negWrapper(lazyRogue.masks.isSwinged, negate))
		return true
	end
