...
function lazyPriestLoad.LoadParsePriest()
	...
	lazyPriest.actions.shadowmend                = lazyPriest.Action:New("shadowmend",                 "Spell_Shadow_ShadowMend")
	...
	lazyPriest.actions.tkjc                      = lazyPriest.Action:New("tkjc",                       "Spell_Shadow_PainSpike")
	...
	lazyPriest.actions.qf                        = lazyPriest.Action:New("qf",                         "btnholyscriptures")
	lazyPriest.actions.zf                        = lazyPriest.Action:New("zf",                         "Spell_Holy_UnyieldingFaith")
	lazyPriest.actions.afd                       = lazyPriest.Action:New("afd",                        "Ability_Racial_Avatar")
	...
	function lazyPriest.masks.isSwinged()
		if not st_timer then
			lazyPriest.p("need SP_SwingTimer.")
			return false
		end
	...
	function lazyScript.bitParsers.ifSwinged(bit, actions, masks)
		...
		table.insert(masks, lazyScript.negWrapper(lazyPriest.masks.isSwinged, negate))
		return true
	end
