...
function lazyWarriorLoad.LoadWarriorLocalization(locale)
	...
	lazyWarriorLocale.enUS.ACTION_TTS.intervene         = "Intervene"
	...
	if (locale == "zhCN") then
		...
		lazyWarriorLocale.zhCN.ACTION_TTS.bloodrage         = "血性狂暴"
		lazyWarriorLocale.zhCN.ACTION_TTS.charge            = "冲锋"
		lazyWarriorLocale.zhCN.ACTION_TTS.battleShout       = "战斗怒吼"
		lazyWarriorLocale.zhCN.ACTION_TTS.thunderClap       = "雷霆一击"
		lazyWarriorLocale.zhCN.ACTION_TTS.rend              = "撕裂"
		lazyWarriorLocale.zhCN.ACTION_TTS.hamstring         = "断筋"
		lazyWarriorLocale.zhCN.ACTION_TTS.heroicStrike      = "英勇打击"
		lazyWarriorLocale.zhCN.ACTION_TTS.sunder            = "破甲攻击"
		lazyWarriorLocale.zhCN.ACTION_TTS.overpower         = "压制"
		lazyWarriorLocale.zhCN.ACTION_TTS.demoShout         = "挫志怒吼"
		lazyWarriorLocale.zhCN.ACTION_TTS.revenge           = "复仇"
		lazyWarriorLocale.zhCN.ACTION_TTS.mockingBlow       = "惩戒痛击"
		lazyWarriorLocale.zhCN.ACTION_TTS.shieldBlock       = "盾牌格挡"
		lazyWarriorLocale.zhCN.ACTION_TTS.disarm            = "缴械"
		lazyWarriorLocale.zhCN.ACTION_TTS.cleave            = "顺劈斩"
		lazyWarriorLocale.zhCN.ACTION_TTS.execute           = "斩杀"
		lazyWarriorLocale.zhCN.ACTION_TTS.deathWish         = "死亡之愿"
		lazyWarriorLocale.zhCN.ACTION_TTS.intercept         = "拦截"
		lazyWarriorLocale.zhCN.ACTION_TTS.intervene         = "援护"
		lazyWarriorLocale.zhCN.ACTION_TTS.berserkerRage     = "狂暴之怒"
		lazyWarriorLocale.zhCN.ACTION_TTS.whirlwind         = "旋风斩"
		lazyWarriorLocale.zhCN.ACTION_TTS.pummel            = "拳击"
		lazyWarriorLocale.zhCN.ACTION_TTS.bloodthirst       = "嗜血"
		lazyWarriorLocale.zhCN.ACTION_TTS.piercingHowl      = "刺耳怒吼"
		lazyWarriorLocale.zhCN.ACTION_TTS.taunt             = "嘲讽"
		lazyWarriorLocale.zhCN.ACTION_TTS.battle            = "战斗姿态"
		lazyWarriorLocale.zhCN.ACTION_TTS.defensive         = "防御姿态"
		lazyWarriorLocale.zhCN.ACTION_TTS.berserk           = "狂暴姿态"
		lazyWarriorLocale.zhCN.ACTION_TTS.lastStand         = "破釜沉舟"
		lazyWarriorLocale.zhCN.ACTION_TTS.shieldBash        = "盾击"
		lazyWarriorLocale.zhCN.ACTION_TTS.mortalStrike      = "致死打击"
		lazyWarriorLocale.zhCN.ACTION_TTS.shieldSlam        = "盾牌猛击"
		lazyWarriorLocale.zhCN.ACTION_TTS.sweepingStrikes   = "横扫攻击"
		lazyWarriorLocale.zhCN.ACTION_TTS.concussionBlow    = "震荡猛击"
		lazyWarriorLocale.zhCN.ACTION_TTS.challengingShout  = "挑战怒吼"
		lazyWarriorLocale.zhCN.ACTION_TTS.intimidatingShout = "破胆怒吼"
		lazyWarriorLocale.zhCN.ACTION_TTS.recklessness      = "鲁莽"
		lazyWarriorLocale.zhCN.ACTION_TTS.retaliation       = "反击风暴"
		lazyWarriorLocale.zhCN.ACTION_TTS.shieldWall        = "盾墙"
		lazyWarriorLocale.zhCN.ACTION_TTS.slam              = "猛击"
		lazyWarriorLocale.zhCN.ACTION_TTS.fj                = "反击"

		-- ParseWarrior.lua
		WARRIOR_STANCE = "姿态："
		ITEM_SUBTYPE_SHIELDS = "盾牌"
		JUDGE_SLAM = "猛击"
	end
end
