...
function lazyShamanLoad.LoadParseShaman()
	...
	lazyShaman.actions.bloodlust           = lazyShaman.Action:New("bloodlust",         "Spell_Nature_BloodLust")
	lazyShaman.actions.earthShock          = lazyShaman.Action:New("earthShock",        "Spell_Nature_EarthShock")
	lazyShaman.actions.earthShield         = lazyShaman.Action:New("earthShield",       "Spell_Nature_SkinofEarth")
	...
	lazyShaman.actions.fbdj                = lazyShaman.Action:New("fbdj",              "Ability_Shaman_StormStrike")
	lazyShaman.actions.sddj                = lazyShaman.Action:New("sddj",              "Spell_Nature_ThunderClap")
	lazyShaman.actions.lhlj                = lazyShaman.Action:New("lhlj",              "Spell_Shaman_SpiritLink")
	lazyShaman.actions.totemRecall         = lazyShaman.Action:New("totemRecall",       "Spell_Shaman_TotemRecall")
	...
	function lazyShaman.masks.isSwinged()
		if not st_timer then
			lazyShaman.p("need SP_SwingTimer.")
			return false
		end
	...
	function lazyScript.bitParsers.ifSwinged(bit, actions, masks)
		...
		table.insert(masks, lazyScript.negWrapper(lazyShaman.masks.isSwinged, negate))
		return true
	end
